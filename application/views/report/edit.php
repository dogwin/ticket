...
<div id="new_ticket" class="zoom-anim-dialog lft-dialog">
	<div class="lft-dialog-tit"><button class="mfp-close" type="button" title="Close (Esc)">×</button>New Report Request</div>
...
$(document).ready(function(){
	...
	$("#save").live('click',function(){
		$("#myform").attr('action','<?php echo base_url('post/addReport')?>');
		var website= '';
